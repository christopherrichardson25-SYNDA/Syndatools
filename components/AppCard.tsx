...
export default function AppCard({
  ...
  name: string; description: string; icon?: string; href: string; online?: boolean; soon?: boolean;
}) {
  return (
    <div className="card p-5">
      ...
      <div className="mt-4">
        {soon ? (
          ...
          <Link href={href} target="_blank" rel="noopener" className="btn btn-primary">Abrir</Link>
        )}
      </div>
    </div>
  )
